...
function TableCellViewer({ item }: { item: z.infer<typeof schema> }) {
  ...
  return (
    <Drawer direction={isMobile ? "bottom" : "right"}>
      <DrawerTrigger className="w-fit px-0 text-left text-foreground text-sm font-medium underline-offset-4 hover:underline bg-transparent border-0 cursor-pointer">{item.header}</DrawerTrigger>
      <DrawerContent>
        ...
        <DrawerFooter>
          ...
          <DrawerClose className="h-8 px-3 text-sm font-medium border border-border rounded-4xl bg-input/30 hover:bg-input/50 transition-all cursor-pointer">Close</DrawerClose>
        </DrawerFooter>
      </DrawerContent>
    </Drawer>
  )
