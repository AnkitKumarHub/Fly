...
export const EVENT_COLORS = [
  { bg: "bg-[#D6E9FF]", text: "text-[#1e3a5f]", border: "border-[#b8d4f5]" },
  { bg: "bg-[#D1F8E1]", text: "text-[#1a3d2e]", border: "border-[#b0e8c8]" },
  { bg: "bg-[#FFEAD2]", text: "text-[#5c3d1e]", border: "border-[#f0d4b0]" },
  { bg: "bg-[#EDE4F7]", text: "text-[#3d2e5c]", border: "border-[#d4c4eb]" },
  { bg: "bg-[#F5E6E8]", text: "text-[#5c2e35]", border: "border-[#e8c8cc]" },
] as const
